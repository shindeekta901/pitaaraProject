...
<body>
    <div class="container">
        <div class="auth-card mx-auto">
            ...
            <div class="auth-body">
                <form action="otp" method="post"class="needs-validation" novalidate>
                    <div class="mb-4">
                        <label for="username" class="form-label">OTP</label>
                        <div class="input-group">
                            <span class="input-group-text"><i class="bi bi-person"></i></span>
                            <input type="text" class="form-control" id="username" name="otp" placeholder="Enter your username" required>
                    ...
                    <div class="d-grid gap-2">
                        <button type="submit" class="btn btn-purple">Submit OTP</button>
                    </div>
                </form>
            </div>
